...
firstName = input("Hello player! Before we get started what is your name?\n\n")
...
class Characters:
    ...
    def surrender(self):
        print("Ducth catches you with with his lasso and pulls you back into the fight\n")
        time.sleep(1)
   ...
   `----|_|---`
       ((_))
        `-`""")
            ...
            print("""
You pulled out your revolver and charge your deadeye ability. \n\n
